...
public class ForgotPasswordCommandHandlerTests
{
    ...
    public async Task Handle_ShouldGenerateOtpAndPersistToken_WhenUserExists()
    {
        ...
        TelecomPM.Domain.Entities.PasswordResetTokens.PasswordResetToken? capturedToken = null;
        tokenRepository
            .Setup(r => r.AddAsync(It.IsAny<TelecomPM.Domain.Entities.PasswordResetTokens.PasswordResetToken>(), It.IsAny<CancellationToken>()))
            .Callback<TelecomPM.Domain.Entities.PasswordResetTokens.PasswordResetToken, CancellationToken>((token, _) => capturedToken = token)
