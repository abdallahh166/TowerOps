...
public class SiteAssignmentServiceTests
{
    private sealed class FakeUserRepository : IUserRepository
    {
        ...
        public Task<IReadOnlyList<User>> FindAsync(TowerOps.Domain.Specifications.ISpecification<User> specification, CancellationToken cancellationToken = default)
            => Task.FromResult<IReadOnlyList<User>>(_users);

        public Task<User?> FindOneAsync(TowerOps.Domain.Specifications.ISpecification<User> specification, CancellationToken cancellationToken = default)
        ...
        public Task<IReadOnlyList<User>> FindAsNoTrackingAsync(TowerOps.Domain.Specifications.ISpecification<User> specification, CancellationToken cancellationToken = default)
            => Task.FromResult<IReadOnlyList<User>>(_users);

        public Task<User?> FindOneAsNoTrackingAsync(TowerOps.Domain.Specifications.ISpecification<User> specification, CancellationToken cancellationToken = default)
            => Task.FromResult<User?>(null);

        // ==================== QUERY OPERATIONS ====================
        public Task<int> CountAsync(TowerOps.Domain.Specifications.ISpecification<User> specification, CancellationToken cancellationToken = default)
            => Task.FromResult(0);

        public Task<bool> ExistsAsync(TowerOps.Domain.Specifications.ISpecification<User> specification, CancellationToken cancellationToken = default)
    ...
    private sealed class FakeSiteRepository : ISiteRepository
    {
        ...
        public Task<IReadOnlyList<Site>> FindAsync(TowerOps.Domain.Specifications.ISpecification<Site> specification, CancellationToken cancellationToken = default)
            => Task.FromResult<IReadOnlyList<Site>>(new List<Site>());

        public Task<Site?> FindOneAsync(TowerOps.Domain.Specifications.ISpecification<Site> specification, CancellationToken cancellationToken = default)
            => Task.FromResult<Site?>(null);
        ...
        public Task<IReadOnlyList<Site>> FindAsNoTrackingAsync(TowerOps.Domain.Specifications.ISpecification<Site> specification, CancellationToken cancellationToken = default)
            => Task.FromResult<IReadOnlyList<Site>>(new List<Site>());

        public Task<Site?> FindOneAsNoTrackingAsync(TowerOps.Domain.Specifications.ISpecification<Site> specification, CancellationToken cancellationToken = default)
            => Task.FromResult<Site?>(null);
        ...
        // ==================== QUERY OPERATIONS ====================
        public Task<int> CountAsync(TowerOps.Domain.Specifications.ISpecification<Site> specification, CancellationToken cancellationToken = default)
            => Task.FromResult(0);

        public Task<bool> ExistsAsync(TowerOps.Domain.Specifications.ISpecification<Site> specification, CancellationToken cancellationToken = default)
            => Task.FromResult(false);
